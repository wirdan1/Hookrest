...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=62895323195263">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>Hookrest</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        ...
        to: email,
        subject: `Verify Email - Api Hookrest`,
        html: inboxGmail,
      };
